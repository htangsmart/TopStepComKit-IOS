...
+ (instancetype)modelWithBlongDay:(long)belongDay record_time:(long)record_time start_time:(long)start_time duration:(int)duration type:(TPSHistorySleep_Type)type;
